(function () {
    ...
    //UNITY STUFF
    var buildUrl = "Build";
    var loaderUrl = buildUrl + "/Unity_NorthFace_WebGL.loader.js";
    var config = {
        dataUrl: buildUrl + "/Unity_NorthFace_WebGL.data",
        frameworkUrl: buildUrl + "/Unity_NorthFace_WebGL.framework.js",
        codeUrl: buildUrl + "/Unity_NorthFace_WebGL.wasm",
